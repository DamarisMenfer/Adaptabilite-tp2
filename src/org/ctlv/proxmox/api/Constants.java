...
public class Constants {
	...
	public static String CT_BASE_NAME = "ct-tpgei-virt-B4-ct1";  // "XX" � remplacer par votre num�ro de bin�me. Exemple: ct-tpgei-virt-A3-ct � concat�ner avec le num�ro du CT
